...
<div class="container" style="display: flex; margin: 0; padding: 0;">
        ...
        <div class="content" style="flex: 1; padding: 30px; background-color: #f5f5f5;">
            <h1 style="font-size: 2rem; font-weight: 700; color: #2f1b12; margin-bottom: 8px;">Add Product</h1>
            <hr style="width: 120px; height: 3px; background-color: #714423; border: none; margin: 15px 0 20px; border-radius: 2px;">
